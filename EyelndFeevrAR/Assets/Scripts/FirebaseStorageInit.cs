namespace Firebase.Sample.Storage
{
    ...
    public class FirebaseStorageInit : MonoBehaviour
{
        public string MyStorageBucket = "gs://YOUR-FIREBASE-BUCKET/";
        ...
        protected virtual void InitializeFirebaseStorage()
        {
        ...
        {
            Task task;
            FirebaseStorageInit uiHandler;

            // Create an enumerator that waits for the specified task to complete.
            public WaitForTaskCompletion(FirebaseStorageInit uiHandler, Task task)
            {
        ...
        public void GUIDisplayControls()
        {
            if (UIEnabled)
            {
